// ./commands/compliment_weird.js
// ========

var parent = require.main.exports;

module.exports = {
    name: "hhb compliment_weird",
    version_added: "2.0",
    commands_regex: "(compliment(_|)|)weird(|_)(com(pliment|)|insult|)",
            ...
            if (command_args.length < 3) {
                ...
                parent.functions.getJSON("https://complimentr.com/api", "", function (err, data) {
                    if (err) {
                        ...
                        parent.functions.twitch_clientsay(channel, ` @${command_args[2].replace("@", "")}, ${data.compliment.toLowerCase()} `);
                    }
                    return;
                }, 'GET')
            }
