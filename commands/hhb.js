...
module.exports = {
    ...
    invocation: async (platform, channel, tags, message) => {
        ...
        var return_message = parent.hannahbot_storage.vars.bot_enabled ? `I'm hannahbot, use "${command_args[0]} help" for a list of commands.`: `I'm hannahbot. I am currently in maintainance, please bear with me.`
